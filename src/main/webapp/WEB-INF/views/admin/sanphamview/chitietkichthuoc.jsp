...
<body>
<div class="container">
    <h1 class="text-center">Chi tiết kích thước</h1>
    <div style="margin-top: 55px">
        <form:form action="/admin/sanphamview/updateKT" method="post" modelAttribute="kichthuoc">
            ...
            <div class="mt-3">
                Tên kích thước: <form:input path="tenkt" cssClass="form-control" cssStyle="width: 400px"/>
            ...
            <div class="text-center mt-3">
                <a href="/admin/sanphamview/kichthuoc" class="btn btn-secondary">Quay lại</a>
